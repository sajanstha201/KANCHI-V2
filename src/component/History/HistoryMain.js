...
export const HistoryMain=()=>{
    ...
    return(
        <div className={` bg-gray-300 absolute pt-10 md:relative z-10 h-full ${isHistoryHidden?' left-[-500px] w-0':'w-[300px] left-0'} transition-all duration-500 ease-in-out`}>
